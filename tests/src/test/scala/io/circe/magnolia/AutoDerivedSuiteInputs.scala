...
object AutoDerivedSuiteInputs extends AllSyntax:
  ...
  object InnerCaseClassExample:
    implicit val arbitraryInnerCaseClassExample
        : Arbitrary[InnerCaseClassExample] =
      Arbitrary(
        for
  ...
  object OuterCaseClassExample:
    implicit val eqOuterCaseClassExample: Eq[OuterCaseClassExample] =
      Eq.fromUniversalEquals

    implicit val arbitraryOuterCaseClassExample
        : Arbitrary[OuterCaseClassExample] =
      Arbitrary(
        for
          a <- Arbitrary.arbitrary[String]
  ...
  object RecursiveWithListExample:
    ...
    implicit val arbitraryRecursiveWithListExample
  ...
  object WithTaggedMembers:
    implicit val eqWithTaggedMembers: Eq[WithTaggedMembers] =
      Eq.fromUniversalEquals

    implicit val arbitraryWithTaggedMembers: Arbitrary[WithTaggedMembers] =
      Arbitrary(
        for
  ...
  object WithSeqOfTagged:
    implicit val eqSeqOfWithSeqOfTagged: Eq[Seq[WithSeqOfTagged]] =
      Eq.fromUniversalEquals

    implicit val arbitraryWithSeqOfTagged: Arbitrary[WithSeqOfTagged] =
      Arbitrary(
